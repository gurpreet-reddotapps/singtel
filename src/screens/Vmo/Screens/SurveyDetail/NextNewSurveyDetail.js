...
import { FetchEstimateMaterailAPI, NewSurveyDetailAPI } from '../../api';
...
const NextNewSurveyDetail = (props) => {
    ...
    const { SurveyorID,
        ...
        startDate,
        ApprovaalType,
        ApprovalLabourDays, } = props?.route?.params

    console.log(startDate, "SAY MY NAME");
    ...
    const SaveNewSurveyDetail = () => {
        ...
        if (ApprovaalType == "Lum sum") {
            ...
            NewSurveyDetailAPI(data).then((res) => {
...
export default NextNewSurveyDetail
