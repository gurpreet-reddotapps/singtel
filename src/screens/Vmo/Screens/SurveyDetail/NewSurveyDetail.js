...
import { FetchSurveyorAPI } from '../../api';



const NewSurveyDetail = (props) => {
    ...
    const takeDataNext = () => {
        if (SurveyorID !== undefined && surveyorName !== undefined && company !== undefined && conatcNumber !== undefined && startDate !== undefined && ApprovaalType !== undefined && ApprovalLabourDays !== undefined) {
            let nextObject = {
                ...
                ApprovalLabourDays: ApprovalLabourDays,
            }
            navigation.navigate(NavigationString.NEXT_NEW_SURVEY_DETAIL, nextObject)
        } else {
    ...
    return (
        <>
            <SafeAreaView style={styles.NewSurveyDetailWrapper} >
                ...
                <VMOCustomHeader title={"New survey report"} backIcon />
...
export default NewSurveyDetail
