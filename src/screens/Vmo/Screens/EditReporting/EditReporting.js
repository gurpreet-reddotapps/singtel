...
import { CheckOrderExistAPI, FetchAllCustomersAPI, FetchCustomerVehicleAPI, NewOrderAPI, UpdateReportingAPI, UploadDocumnetAPI } from '../../api'
...
import StringImagePreview from '../../Components/StringImagePreview'
...
const EditReporting = (props) => {
    ...
    let otherDetailData = JSON.parse(item?.other_details)
    let RemarkData = JSON.parse(item?.remarks)

    console.log(item, "SHOW THE PARAM");
    console.log(otherDetailData, "SHOW THE otherDetailData");
    console.log(RemarkData, "SHOW THE RemarkData");
    ...
    const StepWiseComponent = () => {
        ...
        const [reamrkTextArray, setreamrkTextArray] = useState(RemarkData)
        ...
        // Step Three
        const [AccidentalDate, setAccidentalDate] = useState(AccidentalDate == undefined ? otherDetailData?.accident_date : AccidentalDate);
        const [AccidentalTime, setAccidentalTime] = useState(AccidentalTime == undefined ? otherDetailData?.accident_time : AccidentalTime);
        const [Driver, setDriver] = useState(Driver == undefined ? otherDetailData?.driver : Driver);
        const [location, setlocation] = useState(location == undefined ? otherDetailData?.location : location);
        const [NRICNumber, setNRICNumber] = useState(NRICNumber == undefined ? otherDetailData?.nric_number : NRICNumber);
        const [EPval, setEPval] = useState(EPval == undefined ? otherDetailData?.ep_number : EPval);
        const [SPval, setSPval] = useState(SPval == undefined ? otherDetailData?.sp_number : SPval);
        const [WPval, setWPval] = useState(WPval == undefined ? otherDetailData?.wp_number : WPval);
        const [DamageStatus, setDamageStatus] = useState(DamageStatus == undefined ? otherDetailData?.damage_status : DamageStatus);
        const [ThirdParty, setThirdParty] = useState(ThirdParty == undefined ? otherDetailData?.third_party_vehicle_number : ThirdParty);
        const [CostRepair, setCostRepair] = useState(CostRepair == undefined ? otherDetailData?.cost_of_repair : CostRepair);
        const [RecivedAmount, setRecivedAmount] = useState(RecivedAmount == undefined ? otherDetailData?.received_amount : RecivedAmount);
        const [DetailsOfAccident, setDetailsOfAccident] = useState(DetailsOfAccident == undefined ? otherDetailData?.details_of_accident : DetailsOfAccident);
        ...
        const SaveCustomerDetail = () => {
            ...
            let SETTLEMENT = settleMentType == undefined ? item?.settlement_type : settleMentType;
            let Registration = START_DATE == undefined ? moment(item?.booking_date).format('YYYY-MM-DD') : START_DATE;
        ...
        const SaveFiles = () => {
            ...
            let DOC_FILE_URL = docFileUrl == undefined ? item?.gia_report : docFileUrl;
            let QUOTATION_URL = QuotationUrl == undefined ? item?.quotation_report : QuotationUrl;
            let DPTE_DOC_URL = PTEdoc == undefined ? item?.pte_settlement_form : PTEdoc;
            let CERTIFICATE_URL = Certificate == undefined ? otherDetailData?.ci_file : Certificate;
            

            console.log(DOC_FILE_URL, "DOC_FILE_URL");
            console.log(QUOTATION_URL, "QUOTATION_URL");
            console.log(DPTE_DOC_URL, "DPTE_DOC_URL");
            console.log(CERTIFICATE_URL, "CERTIFICATE_URL");

            console.log(docFileUrl, "docFileUrl");
            console.log(QuotationUrl, "QuotationUrl");
            console.log(PTEdoc, "PTEdoc");
            console.log(Certificate, "Certificate");


            if (DOC_FILE_URL !== undefined &&
                QUOTATION_URL !== undefined &&
                DPTE_DOC_URL !== undefined &&
        ...
        const CreateOrder = () => {
            ...
            let OtherData = {
                ...
                cost_of_repair: pageThreeDataValueReporting?.CostRepair,
                received_amount: pageThreeDataValueReporting?.RecivedAmount,
                nric_number: pageThreeDataValueReporting?.NRICNumber,
                ...
                ci_file: pageTwoDataValueReporting?.CERTIFICATE_URL,
                pictures: [],
                incident_number: "",
                employee_name: "",
                dept_name: "",
            ...
            let data = {
                booking_date: pageOneDataValueReporting?.Registration,
                customer_id: pageOneDataValueReporting?.CustomerID,
                gia_report: pageTwoDataValueReporting?.DOC_FILE_URL,
                is_incident_only: false,
                order_id: item?.id,
                other_details: OtherStringData,
                pte_settlement_form: pageTwoDataValueReporting?.DPTE_DOC_URL,
                quotation_report: pageTwoDataValueReporting?.QUOTATION_URL,
                remarks: stringRemarks,
                settlement_type_report: pageOneDataValueReporting?.SETTLEMENT,
                type: 2,
            ...
            UpdateReportingAPI(data).then((res) => {
                console.log(res, "<------");
                if (res.status === 200) {
                    ShowSuccessMessage("REPORTING UPDATED")
                    setloading(false)
                    goNext()
                    navigation.goBack()
                }
        ...
        const removeRemark = (i) => {
            let newArray = [...reamrkTextArray]
            newArray.splice(i, 1)
            setreamrkTextArray(newArray)
        }
        ...
        const remarkTextFunction = (texted, index) => {
            console.log(index, "INDEX ALLTIME")
            console.log(texted, "TEXT ALLTIME")
            let objectText = { "text": texted }
            reamrkTextArray.map((item, ind) => {
                if (index == ind) {
                    item = objectText;
                    reamrkTextArray[ind] = objectText;
                        ...
                        <View style={styles.downShow} >
                            ...
                            </Pressable>
                            {
                                arrayForPicker &&
                                    ...
                                    <RNPickerSelect
                                        ...
                                        value={CustomerID !== undefined ? CustomerID : item?.customer_id}
                            ...
                            <TouchableOpacity style={styles.TouchableDate} activeOpacity={0.5} onPress={showStartDatePicker} >
                                <Text style={styles.textCal} >
                                    ...
                                    {START_DATE == undefined ? moment(item?.booking_date).format('YYYY-MM-DD') : START_DATE}
                                </Text>
                            ...
                            <RNPickerSelect
                                ...
                                value={settleMentType == undefined ? item?.settlement_type : settleMentType}
                                useNativeAndroidPickerStyle={false}
                                Icon={() => {
                                    return <FeIcon name='chevron-down' size={20} color={"#505050"} />
                                }}
                            ...
                            <View style={{ marginBottom: 50, }} >
                                ...
                                <View style={styles.UploadDocumnet} >
                                    <Pressable style={styles.UploadArea} onPress={() => { onSelecFile(1) }} >
                                        ...
                                        <Text style={{ color: colors.textColor }} >Replace File</Text>
                                    </Pressable>

                                    {Filename == undefined ?
                                        <StringImagePreview installerImages={item?.gia_report} title={"GIA Report"} />
                                        :
                                        <>
                                ...
                                <View style={styles.UploadDocumnet} >
                                    ...
                                    {QuoteFileName == undefined ?
                                        <StringImagePreview installerImages={item?.quotation_report} title={"Quotation"} />
                                        :
                                        <>
                                            <View style={styles.fileNameText} >
                                ...
                                <View style={styles.UploadDocumnet} >
                                    ...
                                    {PTEFileName == undefined ?
                                        <StringImagePreview installerImages={item?.pte_settlement_form} title={"PTE Settlement Form"} />
                                        :
                                        <>
                                            <View style={styles.fileNameText} >
                                ...
                                <View style={styles.UploadDocumnet} >
                                    ...
                                    {certificateFileName == undefined ?
                                        <StringImagePreview installerImages={otherDetailData?.ci_file} title={"Certificate of insurance"} />
                                        :
                                        <>
                                            <View style={styles.fileNameText} >
                        ...
                        : page === 3 ?
                            <>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {Driver == undefined ? otherDetailData?.driver : Driver}
                                </TextInput>
                                ...
                                >
                                    <Text style={styles.textCal} >
                                        {ACCIDENT_DATE == undefined ? otherDetailData?.accident_date : ACCIDENT_DATE }
                                    </Text>
                                ...
                                >
                                    <Text style={styles.textCal} >
                                    {ACCIDENTA_TIME == undefined ? moment(otherDetailData?.accident_time).format('hh:mm:ss')  : ACCIDENTA_TIME }
                                    </Text>
                                    <Calender width={20} height={20} />
                                </TouchableOpacity>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {location == undefined ? otherDetailData?.location : location}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {NRICNumber == undefined ? otherDetailData?.nric_number : NRICNumber}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {EPval == undefined ? otherDetailData?.ep_number : EPval}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {SPval == undefined ? otherDetailData?.sp_number : SPval}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {WPval == undefined ? otherDetailData?.wp_number : WPval}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {DamageStatus == undefined ? otherDetailData?.damage_status : DamageStatus}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {ThirdParty == undefined ? otherDetailData?.third_party_vehicle_number : ThirdParty}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {CostRepair == undefined ? otherDetailData?.cost_of_repair : CostRepair}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {RecivedAmount == undefined ? otherDetailData?.received_amount : RecivedAmount}
                                </TextInput>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                >
                                    {DetailsOfAccident == undefined ? otherDetailData?.details_of_accident : DetailsOfAccident}
                                </TextInput>
    ...
    return (
        <SafeAreaView style={styles.NewOrderStyle} >
            <VMOCustomHeader title={`Edit Reporting #${item?.id}`} backIcon />
            <View>
