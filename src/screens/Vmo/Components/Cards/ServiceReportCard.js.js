            ...
            <Pressable style={styles.FuelCardAreaNNT} onPress={onPressHandler} >
                <ImageBackground
                    ...
                    style={[styles.UpperCardArea,
                        // { backgroundColor: props?.ScreenName == "Job Details" ? '#FFA600' : props?.ScreenName == "Timeline" ? "#2672AB" : null, }
                    ]} >
                    {props?.ProductImage ?
                        <View style={styles.EngineImageView} >
                            <Image style={styles.EngineImage} source={{ uri: props?.ProductImage }} />
                            <Text style={styles.CardHeading} >Tyre Michelin W12, D20</Text>
                        </View>
                        :
                        <View style={styles.EngineImageView} >
                            <Image style={styles.EngineImage} source={Images.Tyre} />
                            <Text style={styles.CardHeading} >Tyre Michelin W12, D20</Text>
                        </View>
                    }
                </ImageBackground>
                        ...
                        <View style={styles.JobDateUp}>
                            <View style={styles.StartDate}>
                                <View styles={styles.UpperText}>
                                    <Text styles={styles.cardTextGrey}>Remarks</Text>
                    ...
                    <View style={styles.threeItem} >
                        <View style={styles.JobDetails}>
                            <View style={styles.JobDate}>
                                <View styles={styles.UpperText}>
                                    <Text styles={styles.cardTextGrey}>Created By</Text>
                                    <Text style={styles.cardTextBlack}>{props?.item?.created_by_name}</Text>
                                </View>
                            </View>
                            <View style={styles.JobDate}>
                                <View styles={styles.UpperText}>
                                    <Text styles={styles.cardTextGrey}>Status</Text>
                            ...
                            <View style={styles.JobDate}>
                                ...
                                <View styles={styles.UpperText}>
                                    <Text styles={styles.cardTextGrey}>Amount</Text>
