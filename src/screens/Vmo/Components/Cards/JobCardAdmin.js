...
const JobCardAdmin = (props) => {
    ...
    return (
        <Pressable style={styles.cardWrapper} activeOpacity={0.8} onPress={() => { }} >
            <ImageBackground source={'OD' == props.jobStatus ? Images.OverDueUpperCard : 'IP' == props.jobStatus ? Images.inProgressupperCard : 'CO' == props.jobStatus ? Images.CheckOutUpperCard : 'CD' == props.jobStatus ? Images.lightGreen : null} style={[styles.UpperCardArea,
             { backgroundColor: 'OD' == props.jobStatus ? "#FFA600" : 'IP' == props.jobStatus ? "#1F8B88" : 'CO' == props.jobStatus ? "#FF6161" : 'CD' == props.jobStatus ? "#22AF63" : "#FFA600", }]} >
            ...
            <View style={styles.JobDetail}>
                ...
                <View style={styles.JobOtherDetail}>
                    ...
                    <View style={styles.DownText}>
                        <Text style={styles.cardTextGrey}>Assigened To</Text>
                        <Text style={styles.cardTextBlack}>{props?.data?.type == 1 ? "Mechanic" : props?.data?.type == 2 ? "QC" : props?.data?.type == 3 ? "Washer" : "ADMIN"}</Text>
                    </View>
                </View>
            </View>
